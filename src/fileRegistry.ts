...
export const SECRET_EXTENSIONS: Set<string> = new Set([
 ...
 */
export const SECRET_FILENAMES: Set<string> = new Set([
    '.env',
 ...
 */
export const SAFE_ENV_SUFFIXES: Set<string> = new Set([
...
export const BUILT_IN_EXTENSIONS: Set<string> = new Set(Object.keys(LANGUAGE_MAP));

/** All exact filenames (no extension) supported out of the box. */
export const BUILT_IN_FILENAMES: Set<string> = new Set([
 ...
 */
export const HIGH_PRIORITY_FILENAMES: Map<string, number> = new Map([
 ...
 */
export const FILENAME_TECH_SIGNALS: Map<string, string[]> = new Map([
 ...
 */
export const NPM_DEP_SIGNALS: Map<string, string> = new Map([
    ['react',                'React'],
    ['next',                 'Next.js'],
    ['vue',                  'Vue.js'],
    ['nuxt',                 'Nuxt.js'],
 ...
 */
export const PYTHON_DEP_SIGNALS: Map<string, string> = new Map([
    ['torch',          'PyTorch'],
    ['tensorflow',     'TensorFlow'],
    ['jax',            'JAX'],
    ['scikit-learn',   'scikit-learn'],
...
export const EMBEDDED_EXTENSIONS: Set<string> = new Set(['.ino', '.c', '.h', '.cpp', '.hpp']);
